...
<body>
	<form method="POST" action="/students/update">
		...
		Age: <br>
		<input type="number" name="age" value="{{ $stud->age }}">
		<br>
		
		Course: <br>
		<input type="text" name="course" value="{{ $stud->course }}"><br>
		
		Address <br>
			<textarea name="address" rows="3" cols="40">{{ $stud->address }}</textarea> <br>
		</h3>
